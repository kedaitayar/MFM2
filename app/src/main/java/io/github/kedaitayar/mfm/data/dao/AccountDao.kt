...
interface AccountDao {
    ...
    fun getAccountTransactionChartData(accountId: Long, timeFrom: OffsetDateTime, timeTo: OffsetDateTime, timeToPrevMonth: OffsetDateTime): LiveData<List<AccountTransactionChartData>>
