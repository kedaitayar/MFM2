...
@Database(
    entities = [Account::class, Transaction::class, TransactionType::class, Budget::class, BudgetTransaction::class, BudgetType::class, BudgetDeadline::class, QuickTransaction::class],
    version = 11,
    exportSchema = true
)
...
abstract class MFMDatabase : RoomDatabase() {
    ...
    abstract fun quickTransactionDao(): QuickTransactionDao
                    ...
                    .addCallback(object : RoomDatabase.Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            ioThread {
                                ...
                                getDatabase(context).basicDao()
                                    .insert2(Account(accountId = 1, accountName = "Cash"))
                            }
                        }
                    })
